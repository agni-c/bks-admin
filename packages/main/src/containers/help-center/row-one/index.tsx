        ...
        <Row>
          <Col sm={6}>
            <InstallBox
              ...
              items={[
                ...
                {
                  text: "NPM version not showing when doing command",
                  path: "#!",
                },
              ]}
            />
          ...
          <Col sm={6} mt={["20px", 0]}>
            <InstallBox
              ...
              items={[
                {
                  text: "Common errors when intalling Bootstrap",
                  path: "#!",
                },
                {
                ...
                {
                  text: "Example of bootsrap page using navbar",
                  path: "#!",
                },
              ]}
            />
          ...
          <Col sm={6} mt={["20px", "30px"]}>
            <InstallBox
              ...
              items={[
                {
                  text: "Minimize sass to css without bootstrap",
                  path: "#!",
                },
                {
                  text: "Adding more utilities classes in sass",
                  path: "#!",
                },
              ]}
            />
