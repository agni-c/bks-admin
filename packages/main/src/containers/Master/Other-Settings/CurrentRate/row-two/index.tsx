    ...
    <Table mt="40px" borderBottomWidth={1}>
      <thead>
        <tr>
          ...
          <StyledTH textAlign="center">Sell</StyledTH>
          <StyledTH textAlign="right">Created On</StyledTH>
          <StyledTH textAlign="right">Modified On</StyledTH>
          <StyledTH textAlign="right">Status</StyledTH>
