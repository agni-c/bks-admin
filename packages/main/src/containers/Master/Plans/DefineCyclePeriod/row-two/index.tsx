    ...
    <Table mt="40px" borderBottomWidth={1}>
      <thead>
        <tr>
          ...
          <StyledTH textAlign="center">Cycle in days</StyledTH>
          <StyledTH textAlign="right">Grace Period in hours</StyledTH>
          <StyledTH textAlign="right">Minimum Weight</StyledTH>
          <StyledTH textAlign="right">Minimum Value</StyledTH>
          <StyledTH textAlign="right">Short Name</StyledTH>
