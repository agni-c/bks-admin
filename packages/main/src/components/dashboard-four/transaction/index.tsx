    ...
    <Card height="100%">
      ...
      <ListGroup flush>
        <ListGroupItem display="flex" px={[null, "20px"]}>
          ...
          <StyledListMiddle>
            <StyledListTitle>Process refund to #00910</StyledListTitle>
            <StyledListText>Mar 21, 2019, 1:00pm</StyledListText>
          </StyledListMiddle>
          <StyledListEnd>
            <StyledListTrans>-$16.50</StyledListTrans>
            <StyledListStatus $status="complete">Completed</StyledListStatus>
          </StyledListEnd>
        </ListGroupItem>
        <ListGroupItem display="flex" px={[null, "20px"]}>
          <Avatar display={["none", "block"]}>
          ...
          <StyledListMiddle>
            <StyledListTitle>Process delivery to #44333</StyledListTitle>
            <StyledListText>Mar 20, 2019, 11:40am</StyledListText>
          </StyledListMiddle>
          <StyledListEnd>
            <StyledListTrans>3 Items</StyledListTrans>
            <StyledListStatus $status="pickup">For pickup</StyledListStatus>
          </StyledListEnd>
        </ListGroupItem>
        <ListGroupItem display="flex" px={[null, "20px"]}>
          <Avatar display={["none", "block"]}>
        ...
        <ListGroupItem display="flex" px={[null, "20px"]}>
          ...
          <StyledListMiddle>
            <StyledListTitle>Payment failed from #087651</StyledListTitle>
            <StyledListText>Mar 19, 2019, 12:54pm</StyledListText>
          </StyledListMiddle>
          <StyledListEnd>
            <StyledListTrans>$150.00</StyledListTrans>
            <StyledListStatus $status="cancel">Declined</StyledListStatus>
          </StyledListEnd>
        </ListGroupItem>
      </ListGroup>
      <StyledFooter>
