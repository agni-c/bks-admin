...
const TotalVisits: FC = () => {
  return (
    <Card>
      <StyledHeader>
        <SectionTitle title="Total Visits" titleProps={{ lineHeight: 1.5 }} />
        <StyledDropdown>
        ...
        <StyledTable borderless compact mb="0px">
          <thead>
            <StyledHeadTR>
              ...
              <StyledTH textAlign="right">Percentage (%)</StyledTH>
          ...
          <tbody>
            <tr>
              ...
              <StyledTD textAlign="right">
                <StyledProgressWrap>
                  <Progress height="4px" now={65.35} bg="teal" />
                </StyledProgressWrap>
              </StyledTD>
            ...
            <tr>
              ...
              <StyledTD textAlign="right">
                <StyledProgressWrap>
                  <Progress height="4px" now={84.97} bg="primary" />
                </StyledProgressWrap>
              </StyledTD>
              <StyledTD fontWeight={500} textAlign="right">
                84.97%
            ...
            <tr>
              ...
              <StyledTD fontWeight={500}>List of Products</StyledTD>
              <StyledTD textAlign="right">
                <StyledProgressWrap>
                  <Progress height="4px" now={38.66} bg="warning" />
                </StyledProgressWrap>
              </StyledTD>
              <StyledTD fontWeight={500} textAlign="right">
                38.66%
            ...
            <tr>
              ...
              <StyledTD textAlign="right">
                <StyledProgressWrap>
                  <Progress height="4px" now={16.11} bg="danger" />
                </StyledProgressWrap>
              </StyledTD>
              <StyledTD fontWeight={500} textAlign="right">
                16.11%
            ...
            <tr>
              ...
              <StyledTD fontWeight={500}>Product 50% Sale</StyledTD>
              <StyledTD textAlign="right">
                <StyledProgressWrap>
                  <Progress height="4px" now={59.34} bg="teal" />
                </StyledProgressWrap>
              </StyledTD>
              <StyledTD fontWeight={500} textAlign="right">
                59.34%
