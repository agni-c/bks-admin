        ...
        <StyledTable borderless compact mb="0px">
          <thead>
            <StyledHeadTR>
              ...
              <StyledTH textAlign="right">Conversion Rate</StyledTH>
            </StyledHeadTR>
          </thead>
          <tbody>
            <tr>
              <StyledTD textAlign="center">
                <StyledIcon className="fab fa-chrome" color="primary" />
              </StyledTD>
            ...
            <tr>
              <StyledTD textAlign="center">
                <StyledIcon className="fab fa-firefox" color="orange" />
              </StyledTD>
              <StyledTD fontWeight={500}>Mozilla Firefox</StyledTD>
            ...
            <tr>
              <StyledTD textAlign="center">
                <StyledIcon className="fab fa-safari" color="primary" />
              </StyledTD>
            ...
            <tr>
              <StyledTD textAlign="center">
                <StyledIcon className="fab fa-edge" color="primary" />
              </StyledTD>
            ...
            <tr>
              <StyledTD textAlign="center">
                <StyledIcon className="fab fa-opera" color="danger" />
              </StyledTD>
